...
\begin{tabular}{|>{\raggedright}p{58pt}|>{\raggedright}p{109pt}|>{\raggedright}p{1pt}|>{\raggedright}p{17pt}|>{\raggedright}p{28pt}|>{\raggedright}p{0pt}|>{\raggedright}p{18pt}|>{\raggedright}p{20pt}|}
	...
	\textbf{Versión}} & 1.1 \tabularnewline
	\hline
	\end{tabular}
	...
	\begin{tabular}{|>{\raggedright}p{337pt}|}
		...
		\hline
		\multicolumn{1}{|p{337pt}|}{La frecuencia media del caso de uso, será la estimación de que cada paciente realiza una prueba médica al año.} \tabularnewline
		\hline
	\end{tabular}
